...
class clsfooter_boew { //footer_boew class @1-C1B75F83
...
//Class_Initialize Event @1-1E43994C
    function clsfooter_boew($RelativePath, $ComponentName, & $Parent)
    {
        global $CCSLocales;
        ...
        $this->Visible = true;
        $this->Parent = & $Parent;
        $this->FileName = "footer_boew.php";
        $this->Redirect = "";
        $this->TemplateFileName = "footer_boew.html";
...
} //End footer_boew Class @1-FCB6E20C
