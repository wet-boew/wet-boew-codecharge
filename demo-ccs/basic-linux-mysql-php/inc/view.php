...
class clsview { //view class @1-92D244E6
...
//Class_Initialize Event @1-6B44D59B
    function clsview($RelativePath, $ComponentName, & $Parent)
    {
        global $CCSLocales;
        ...
        $this->Visible = true;
        $this->Parent = & $Parent;
        $this->FileName = "view.php";
        $this->Redirect = "";
        $this->TemplateFileName = "view.html";
