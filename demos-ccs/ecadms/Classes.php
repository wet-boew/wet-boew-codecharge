...
//clsCacheManager class @0-3EDB20CE
class clsCacheManager {
  public $DataSource;
  public $Table = "cache";
  ...
  function clsCacheManager() {
    $this->Errors = new clsErrors;
    $this->DataSource = new clsDBmyproject();
  }
  ...
  function GetCacheKey($page, $parameters) {
    ...
    $key = "GET:" . substr($Get, 1) . ":POST:" . substr($Post, 1) . ":Session:" . substr($Session, 1) . ":Locale:" . $CCSLocales->Locale . ":Style:" . $CCProjectStyle . ":Design:" . $CCProjectDesign;
  ...
  function PutObject($key, $object, $duration) {
    if ($this->Errors->count() || is_null($key)) 
      return false;
